...
LFLAGS=-lm
all:	print-2d make-2d stencil-2d stencil-2d-stack omp-stencil-2d-stack omp-stencil-2d
print-2d: print-2d.o
...
omp-stencil-2d-stack: omp-stencil-2d-stack.o
	$(CC) $(LFLAGS) -o omp-stencil-2d-stack omp-stencil-2d-stack.o
omp-stencil-2d: omp-stencil-2d.o
	$(CC) $(LFLAGS) -o omp-stencil-2d omp-stencil-2d.o
clean:
